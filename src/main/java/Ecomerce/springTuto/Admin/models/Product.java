package Ecomerce.springTuto.Admin.models;
...
public class Product {
    ...
    public Product(String name, String description, Double price, Integer stock, Double reduction, String image,Category category) {
        this.name = name;
