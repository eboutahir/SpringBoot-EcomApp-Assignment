...
import com.springTuto.Admin.models.CartItem;
import com.springTuto.Admin.models.ShoppingCart;
import com.springTuto.Admin.repositories.CartItemRepository;
import com.springTuto.Admin.repositories.ProductRepository;
import com.springTuto.Admin.repositories.ShoppingCartRepository;
...
public class ShopService {
    ...
    public ShoppingCart getShoppingCartByUser(AppUser user){
        User acount = accountRepository.findByEmail(user.getUsername());
    ...
    public ShoppingCart creatEmptyCart(AppUser principal) {
        User acount = accountRepository.findByEmail(principal.getUsername());
